...
const SearchInput = (props: SearchInputPropsType) => {
  ...
  return (
    ...
    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg" className="SearchInput__icon">
        <circle cx="9.76663" cy="9.76639" r="8.98856" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M16.0183 16.4849L19.5423 19.9997" stroke="#111827" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
      <input
        style={style}
